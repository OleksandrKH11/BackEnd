...
namespace AspNetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<UsersServise>();
            services.AddSingleton<LaptopService>();

            services.AddTransient<IValidator<PC>,CreateMovieCommandValidator>();
            services.AddTransient<IValidator<Laptop>, CreateLaptopCommandValidator>();
